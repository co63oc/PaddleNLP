...
def _parse_type_hint(hint: str) -> dict:
    ...
    elif origin is Union or (hasattr(types, "UnionType") and origin is types.UnionType):  # noqa: E721
        # Recurse into each of the subtypes in the Union, except None, which is handled separately at the end
        subtypes = [_parse_type_hint(t) for t in args if t is not type(None)]  # noqa: E721
        if len(subtypes) == 1:
